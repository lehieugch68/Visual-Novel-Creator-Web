 ...
 */
final class Version20210810094747 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_2E928A06166053B4');
        $this->addSql('DROP INDEX IDX_2E928A06328AA66F');
        $this->addSql('DROP INDEX IDX_2E928A06DCD6AAE9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_battle_scene AS SELECT id, scene_id, playericon_id, enemyimage_id, title, description, playerhp, enemyhp, playeratk, enemyatk FROM game_battle_scene');
        $this->addSql('DROP TABLE game_battle_scene');
        $this->addSql('CREATE TABLE game_battle_scene (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, scene_id INTEGER DEFAULT NULL, playericon_id INTEGER DEFAULT NULL, enemyimage_id INTEGER DEFAULT NULL, title VARCHAR(255) DEFAULT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, playerhp INTEGER DEFAULT NULL, enemyhp INTEGER DEFAULT NULL, playeratk INTEGER DEFAULT NULL, enemyatk INTEGER DEFAULT NULL, CONSTRAINT FK_2E928A06166053B4 FOREIGN KEY (scene_id) REFERENCES game_scene (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2E928A06328AA66F FOREIGN KEY (playericon_id) REFERENCES game_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2E928A06DCD6AAE9 FOREIGN KEY (enemyimage_id) REFERENCES game_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game_battle_scene (id, scene_id, playericon_id, enemyimage_id, title, description, playerhp, enemyhp, playeratk, enemyatk) SELECT id, scene_id, playericon_id, enemyimage_id, title, description, playerhp, enemyhp, playeratk, enemyatk FROM __temp__game_battle_scene');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_scene AS SELECT id, game_id, background_id, music_id, sceneorder, isbattle, title FROM game_scene');
        $this->addSql('DROP TABLE game_scene');
        $this->addSql('CREATE TABLE game_scene (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, game_id INTEGER DEFAULT NULL, background_id INTEGER DEFAULT NULL, music_id INTEGER DEFAULT NULL, sceneorder INTEGER DEFAULT NULL, isbattle BOOLEAN DEFAULT NULL, title VARCHAR(255) DEFAULT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_EB4A9655E48FD905 FOREIGN KEY (game_id) REFERENCES game (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EB4A9655C93D69EA FOREIGN KEY (background_id) REFERENCES game_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EB4A9655399BBB13 FOREIGN KEY (music_id) REFERENCES game_sound (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game_scene (id, game_id, background_id, music_id, sceneorder, isbattle, title) SELECT id, game_id, background_id, music_id, sceneorder, isbattle, title FROM __temp__game_scene');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_story_scene AS SELECT id, gamescene_id, talkericon_id, characterimage_id, background, text, contextorder FROM game_story_scene');
        $this->addSql('DROP TABLE game_story_scene');
        $this->addSql('CREATE TABLE game_story_scene (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, gamescene_id INTEGER DEFAULT NULL, talkericon_id INTEGER DEFAULT NULL, characterimage_id INTEGER DEFAULT NULL, background VARCHAR(255) NOT NULL COLLATE BINARY, text CLOB DEFAULT NULL COLLATE BINARY, contextorder INTEGER DEFAULT NULL, CONSTRAINT FK_DB6C0D7BF7EACDE6 FOREIGN KEY (gamescene_id) REFERENCES game_scene (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DB6C0D7B8453D1C5 FOREIGN KEY (talkericon_id) REFERENCES game_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_DB6C0D7B2048442D FOREIGN KEY (characterimage_id) REFERENCES game_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO game_story_scene (id, gamescene_id, talkericon_id, characterimage_id, background, text, contextorder) SELECT id, gamescene_id, talkericon_id, characterimage_id, background, text, contextorder FROM __temp__game_story_scene');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_scene AS SELECT id, game_id, background_id, music_id, sceneorder, isbattle, title FROM game_scene');
        $this->addSql('DROP TABLE game_scene');
        $this->addSql('CREATE TABLE game_scene (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, game_id INTEGER DEFAULT NULL, background_id INTEGER DEFAULT NULL, music_id INTEGER DEFAULT NULL, sceneorder INTEGER DEFAULT NULL, isbattle BOOLEAN DEFAULT NULL, title VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO game_scene (id, game_id, background_id, music_id, sceneorder, isbattle, title) SELECT id, game_id, background_id, music_id, sceneorder, isbattle, title FROM __temp__game_scene');
        $this->addSql('DROP TABLE __temp__game_scene');
        $this->addSql('CREATE INDEX IDX_EB4A9655E48FD905 ON game_scene (game_id)');
        $this->addSql('CREATE INDEX IDX_EB4A9655C93D69EA ON game_scene (background_id)');
