 ...
 */
final class Version20210808112058 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game_image ADD COLUMN filename VARCHAR(255) DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE game_sound ADD COLUMN filename VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX IDX_2E928A06328AA66F ON game_battle_scene (playericon_id)');
        $this->addSql('CREATE INDEX IDX_2E928A06DCD6AAE9 ON game_battle_scene (enemyimage_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_image AS SELECT id, url FROM game_image');
        ...
        $this->addSql('INSERT INTO game_image (id, url) SELECT id, url FROM __temp__game_image');
        ...
        $this->addSql('CREATE INDEX IDX_EB4A9655C93D69EA ON game_scene (background_id)');
        $this->addSql('CREATE INDEX IDX_EB4A9655399BBB13 ON game_scene (music_id)');
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_sound AS SELECT id, url FROM game_sound');
        ...
        $this->addSql('INSERT INTO game_sound (id, url) SELECT id, url FROM __temp__game_sound');
