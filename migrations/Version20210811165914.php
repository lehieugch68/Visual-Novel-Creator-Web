 ...
 */
final class Version20210811165914 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_battle_scene (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, playericon_id INTEGER DEFAULT NULL, enemyimage_id INTEGER DEFAULT NULL, scene_id INTEGER DEFAULT NULL, title VARCHAR(255) DEFAULT NULL COLLATE BINARY, description VARCHAR(255) DEFAULT NULL COLLATE BINARY, playerhp INTEGER DEFAULT NULL, enemyhp INTEGER DEFAULT NULL, playeratk INTEGER DEFAULT NULL, enemyatk INTEGER DEFAULT NULL, CONSTRAINT FK_2E928A06328AA66F FOREIGN KEY (playericon_id) REFERENCES game_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2E928A06DCD6AAE9 FOREIGN KEY (enemyimage_id) REFERENCES game_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2E928A06166053B4 FOREIGN KEY (scene_id) REFERENCES game_scene (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
