 ...
 */
final class Version20210811165442 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_story_scene AS SELECT id, gamescene_id, talkericon_id, characterimage_id, text, contextorder FROM game_story_scene');
        $this->addSql('DROP TABLE game_story_scene');
        $this->addSql('CREATE TABLE game_story_scene (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, gamescene_id INTEGER DEFAULT NULL, talkericon_id INTEGER DEFAULT NULL, characterimage_id INTEGER DEFAULT NULL, text CLOB DEFAULT NULL, contextorder INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO game_story_scene (id, gamescene_id, talkericon_id, characterimage_id, text, contextorder) SELECT id, gamescene_id, talkericon_id, characterimage_id, text, contextorder FROM __temp__game_story_scene');
        $this->addSql('DROP TABLE __temp__game_story_scene');
        $this->addSql('CREATE INDEX IDX_DB6C0D7BF7EACDE6 ON game_story_scene (gamescene_id)');
        $this->addSql('CREATE INDEX IDX_DB6C0D7B8453D1C5 ON game_story_scene (talkericon_id)');
