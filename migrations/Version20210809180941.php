 ...
 */
final class Version20210809180941 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_image AS SELECT id, url, filename FROM game_image');
        ...
        $this->addSql('INSERT INTO game_image (id, url, filename) SELECT id, url, filename FROM __temp__game_image');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_sound AS SELECT id, url, filename FROM game_sound');
        ...
        $this->addSql('INSERT INTO game_sound (id, url, filename) SELECT id, url, filename FROM __temp__game_sound');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_image AS SELECT id, url, filename FROM game_image');
        $this->addSql('DROP TABLE game_image');
        $this->addSql('CREATE TABLE game_image (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, url VARCHAR(255) DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO game_image (id, url, filename) SELECT id, url, filename FROM __temp__game_image');
        $this->addSql('DROP TABLE __temp__game_image');
        $this->addSql('DROP INDEX IDX_2836BCAFE48FD905');
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_intro AS SELECT id, game_id, title, content FROM game_intro');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__game_sound AS SELECT id, url, filename FROM game_sound');
        $this->addSql('DROP TABLE game_sound');
        $this->addSql('CREATE TABLE game_sound (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, url VARCHAR(255) DEFAULT NULL, filename VARCHAR(255) DEFAULT NULL)');
        $this->addSql('INSERT INTO game_sound (id, url, filename) SELECT id, url, filename FROM __temp__game_sound');
        $this->addSql('DROP TABLE __temp__game_sound');
        $this->addSql('DROP INDEX IDX_DB6C0D7BF7EACDE6');
        $this->addSql('DROP INDEX IDX_DB6C0D7B8453D1C5');
