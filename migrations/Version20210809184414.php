 ...
 */
final class Version20210809184414 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE game_scene (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, game_id INTEGER DEFAULT NULL, background_id INTEGER DEFAULT NULL, music_id INTEGER DEFAULT NULL, sceneorder INTEGER DEFAULT NULL, isbattle BOOLEAN DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, CONSTRAINT FK_EB4A9655E48FD905 FOREIGN KEY (game_id) REFERENCES game (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EB4A9655C93D69EA FOREIGN KEY (background_id) REFERENCES game_image (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_EB4A9655399BBB13 FOREIGN KEY (music_id) REFERENCES game_sound (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
